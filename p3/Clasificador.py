...
class ClasificadorGenetico(Clasificador):
    def __init__(self, tamPoblacion=100, nEpocas=100, pCruce=0.85, pMut=0.1, pElit=0.05, maxReglas=5, seed=1):
    ...
    def clasifica(self, datosTest, atributosDiscretos, diccionario):
        classifier = self.poblacion[-1:][0][0]
    ...
    def calcularFitnessPoblacion(self):
